...
End Property
Public Sub Initialize(FormChemicalName As String, RequestType As TestingRequestTypeEnum, SLIMDictManager As clsSLIMDictionaryManager, Logger As clsLoggingSystem)
